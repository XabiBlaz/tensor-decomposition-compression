#-----------------------------------------------------------------------------------------------------------------------
# code modified from https://github.com/CasvandenBogaard/VBMF
# already included in reference repo github.com/yuncheng97/Tensor-decomposition-pytorch/tree/main
#-----------------------------------------------------------------------------------------------------------------------
...
def VBMF(Y, cacb, sigma2=None, H=None):
    ...
    if sigma2 is None: 
        ...
        sigma2 = sigma2_opt.x
        logger.debug("Estimated sigma2: %s", sigma2)
